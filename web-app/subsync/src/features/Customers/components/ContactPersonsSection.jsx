...
const ContactPersonsSection = ({ contactPersons, setContactPersons, errors = {} }) => {
    // Keep this defensive check, it's correct and necessary
    const persons = Array.isArray(contactPersons) ? contactPersons : [];

    // Add a console log right before attempting to map
    console.log("ContactPersonsSection: 'persons' variable before map:", persons, "Type:", typeof persons, "Is Array:", Array.isArray(persons));
        ...
        <div className="space-y-6">
            <div className="overflow-x-auto">
                <table className="min-w-full text-sm text-left border border-gray-300 rounded-md overflow-hidden">
                    ...
                    <tbody>
                        {/* THE CRITICAL LINE: Add an additional check directly here */}
                        {persons.length > 0 && Array.isArray(persons) ? ( // <- Add Array.isArray(persons) here
