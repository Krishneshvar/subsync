  ...
  const AddCustomer = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        setSuccessMessage(
          isEditing ? "Customer Updated  ." : "Customer Created Successfully."
        );
        setErrorMessage("");
        if (!isEditing) resetCustomerData();
        const currentPath = location.pathname; // e.g., /john_doe/dashboard/customers
        const userSegment = currentPath.split("/")[1]; // Extracts 'john_doe'
